...
const CURATED_CHIPS = ["Trending", "Breaking", "New"] as const
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 pb-16 pt-6 sm:px-6 sm:pt-8 lg:max-w-none lg:px-12">
      ...
      <div className="min-w-0 space-y-6">
        ...
        >
          <div className="flex gap-1 overflow-x-auto pb-0.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:min-w-0 sm:pb-0">
